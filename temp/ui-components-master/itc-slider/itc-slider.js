...
class ItcSlider {
    ...
    #balanceItems() {
        ...
        if (this.#state.direction === 'next') {
            ...
            if (exItemRectRight < wrapperRect.left - targetWidth) {
                ...
                const round = this.#state.width * this.#state.elListItem.length;
                this.#state.exItemMin.style.transform = `translate(${translate}px, 0)`;
            ...
            if (exItemRectLeft > wrapperRect.right + targetWidth) {
                ...
                elFound.translate = translate;
                this.#state.exItemMax.style.transform = `translate(${translate}px, 0px)`;
                this.#updateExProperties();
            }
        }
        window.requestAnimationFrame(this.#balanceItems.bind(this));
    ...
    #move() {
        ...
        this.#state.elItems.style.transform = `translate(${transform}px, 0)`;
    ...
    #init() {
        ...
        if (this.#config.loop) {
            ...
            this.#state.elListItem[lastIndex].style.transform = `translate(${translate}px, 0px)`;
    ...
    #reset() {
        ...
        this.#autoplay('stop');
        this.#state.elItems.classList.add(transitionNoneClass);
        this.#state.elItems.style.transform = 'translate(0, 0)';
        this.#init();
